...
> ⏰ Última actualización: 2026-06-08 11:07 (UTC+8)

### Modelos destacados

### Claude Opus 4.7 `06-08 11:07`
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-jpVNh09IPGmBr7boPt6yXyHVc9ZTAZAUNjla854IKX4YOsgS` | kimi-k2.5 | 🆕 Nueva | $3 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-i1hSX5aZEUPKuLic5onu8xdoUG6h3GpGqLZQdMIyaHMiB76W` | kimi-k2.5 | 🆕 Nueva | $16 | 10 RPM | 2026-06-09 | Kimi long-context general model |

### Image / Audio / Embedding `06-08 11:07`
