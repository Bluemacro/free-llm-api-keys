...
> ⏰ Última atualização: 2026-05-25 13:07 (UTC+8)
...
### DeepSeek `05-25 13:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-zpH4Ae4HufvsJto8Fq6ADlgCtgyC35EzSKvTmbB1QjC6Ec9C` | deepseek-chat | 🆕 Nova | $15 | 20 RPM | 2026-05-27 | Everyday chat, coding, translation, writing |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `05-25 13:07`
...
### Image / Audio / Embedding `05-25 13:07`
