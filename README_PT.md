...
> ⏰ Última atualização: 2026-06-17 18:30 (UTC+8)

### Modelos em destaque

### Claude Opus 4.7 `06-17 18:30`
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-17 18:30`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-EQzoUXISOz0bplXTy5DtIEh805pr0TfUVtd79gZnR2MChRry` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-19 | Kimi long-context general model |
| `sk-xpTi7NTXlwwRNfmNS1NetNYHeFiZQmoeAYlh0J2VLEZAjTP7` | kimi-k2.5 | 🆕 Nova | $12 | 10 RPM | 2026-06-19 | Kimi long-context general model |

### Image / Audio / Embedding `06-17 18:30`
